...
public class VistaRefinanciacion extends JInternalFrame implements ActionListener{
		...
		private LogicaRefinanciacion_ex _logica_ref_ex;
		private JButton b;
		
	    public VistaRefinanciacion(){
	    	//super(null, "Refinanciación", JDialog.DEFAULT_MODALITY_TYPE.APPLICATION_MODAL);
	    	//b= vpc.getJButtonRef_ex();
	    	super("Refinanciación", true, true, true, true);
		...
		public void actionPerformed(ActionEvent e) {
			...
			if(e.getSource() == guardar){
				...
				vpc.setRef_ex_boolean(true);
					
					_controladorRef_ex.altaRefinanciacion_ex(ar);
					
					if(LogicaRefinanciacion_ex.validarNuevoRef_exUsuario){
							...
							int res_insert = _controladorRef_ex.nuevaRefinanciacion(refVO);
							...
							if(res_insert > 0){
								...
								vpc.getRefinanciacionL().setText("Refinanciado");
	    ...
	    public void setLogicaRefinanciacion_ex(LogicaRefinanciacion_ex _logica_ref_ex){
	    	
	    	this._logica_ref_ex = _logica_ref_ex;
	    }
	    
	    public void setJButtonRef(JButton ref_ex){
