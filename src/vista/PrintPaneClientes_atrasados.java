...
public class PrintPaneClientes_atrasados  extends JPanel implements Printable {

	 private JTable table;
	    
	    private float[] columnWidthPercentage =  {20.0f,5.0f, 5.0f, 40.0f, 5.0f,5.0f, 10.0f, 10.0f};

	    public PrintPaneClientes_atrasados(TableModel model, java.sql.Date fecha) throws IOException {
	        setLayout(new GridBagLayout());
	        //BufferedImage logo = ImageIO.read(...);
	        JLabel header = new JLabel();
	        SimpleDateFormat ft = new SimpleDateFormat("dd/MM/yyyy");
	        String d = ft.format(fecha);
	        header.setText("Clientes atrasados                     Fecha: " + d);
